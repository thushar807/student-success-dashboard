...
st.markdown(""" <style>
body {
background-image: url('[https://images.unsplash.com/photo-1522071820081-009f0129c71c](https://images.unsplash.com/photo-1522071820081-009f0129c71c)');
...
st.markdown("<h1 style='text-align: center; color: #2E8B57;'>🎓 Student Success Predictor Dashboard</h1>", unsafe\_allow\_html=True)

# 🌟 Helper function: Smart Pass/Fail inference

def infer\_pass\_fail(df):
proxy\_cols = \[]
...
uploaded\_file = st.file\_uploader("Upload CSV file", type=\["csv"])
